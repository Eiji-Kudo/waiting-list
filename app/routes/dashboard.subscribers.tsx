...
const mockSubscribers = [
	{ id: 1, name: "田中 太郎", registeredAt: "2025-01-09 14:23", source: "Twitter", blocked: false },
	{ id: 2, name: "山田 花子", registeredAt: "2025-01-09 12:15", source: "掲示板", blocked: false },
	{ id: 3, name: "佐藤 一郎", registeredAt: "2025-01-08 18:42", source: "Instagram", blocked: false },
	{ id: 4, name: "鈴木 美咲", registeredAt: "2025-01-08 10:30", source: "YouTube", blocked: false },
	{ id: 5, name: "高橋 健二", registeredAt: "2025-01-07 09:15", source: "直接", blocked: false },
	{ id: 6, name: "伊藤 裕子", registeredAt: "2025-01-06 16:30", source: "Twitter", blocked: true },
	{ id: 7, name: "渡辺 大輔", registeredAt: "2025-01-05 11:20", source: "掲示板", blocked: false },
	{ id: 8, name: "小林 さくら", registeredAt: "2025-01-04 09:45", source: "Instagram", blocked: false },
];
						...
						{mockSubscribers.map((subscriber) => (
							<tr key={subscriber.id} className="hover:bg-gray-50">
								...
								<td className="px-4 py-3 text-sm">
									<span className={`px-2 py-1 rounded text-xs ${sourceStyles[subscriber.source] || "bg-gray-100 text-gray-700"}`}>
										{subscriber.source}
									</span>
								</td>
								<td className="px-4 py-3 text-sm">
