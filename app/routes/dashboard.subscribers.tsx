			...
			<div className="bg-white rounded-2xl border border-slate-200/80 overflow-hidden mb-6 shadow-sm">
				<div className="p-4 border-b border-slate-100 flex items-center gap-4">
					<input
						type="text"
						placeholder="名前で検索..."
						className="border border-slate-200 rounded-xl px-4 py-2.5 text-sm flex-1 max-w-xs bg-slate-50 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500"
					/>
					<select className="border border-slate-200 rounded-xl px-4 py-2.5 text-sm bg-slate-50 text-slate-700">
						<option>すべて</option>
						<option>アクティブ</option>
