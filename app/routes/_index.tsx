		...
		<section className="pt-36 pb-24 px-6">
			<div className="max-w-4xl mx-auto text-center">
				...
				<p className="text-xl text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
					入力はタイトルと説明文だけ。デザインはテンプレートにおまかせ。
					<br />
					面倒なページ作成は不要。すぐにLINEで先行登録を集め始められます。
				</p>
				<WaitlistForm />
				<div className="mt-6">
					<a
			...
			<div className="max-w-6xl mx-auto">
				...
				<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
					{features.map((feature) => (
						<div
							key={feature.title}
							className="p-6 rounded-2xl bg-slate-50/50 border border-slate-100 hover:border-emerald-200 hover:bg-emerald-50/30 hover:shadow-sm transition-all group"
						>
			...
			<div className="max-w-4xl mx-auto">
				...
				<div className="space-y-6">
					{steps.map((item) => (
						<div
							key={item.step}
							className="flex gap-6 items-start bg-white rounded-2xl p-6 shadow-sm border border-slate-100"
						>
							<div className="w-12 h-12 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl flex items-center justify-center text-white font-bold text-lg shrink-0 shadow-sm">
								{item.step}
							</div>
							<div className="pt-1">
	...
	const options = [
		{
			icon: "⚛️",
			title: "React コンポーネント",
			description: "Reactプロジェクトにnpm installして、コンポーネントとして埋め込み",
			...
			<div className="max-w-5xl mx-auto">
				...
				<div className="grid md:grid-cols-3 gap-6">
					{options.map((option) => (
						<div
							key={option.title}
							className="bg-slate-50/50 border border-slate-100 rounded-2xl p-6 hover:border-emerald-200 hover:shadow-sm transition-all"
						>
	...
	return (
		<section id="pricing" className="py-24 px-6 bg-white">
			<div className="max-w-4xl mx-auto">
				...
				<div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl p-8 md:p-12 text-white text-center shadow-2xl">
					<div className="text-slate-400 text-sm font-medium mb-3 tracking-wide uppercase">
						完全従量課金
					</div>
					<div className="text-4xl md:text-5xl font-bold mb-3 tracking-tight">
						LINE送信料の
						<span className="text-5xl md:text-6xl bg-gradient-to-r from-emerald-400 to-emerald-300 bg-clip-text text-transparent">
							10%
						</span>
					</div>
					<div className="text-slate-400 mb-10">初期費用・月額費用なし</div>

					<div className="bg-white/5 backdrop-blur rounded-2xl p-6 mb-8 border border-white/10">
						<div className="text-left space-y-4">
							<div className="flex justify-between items-center">
								<span className="text-slate-300">初期費用</span>
								<span className="font-semibold text-white">¥0</span>
							</div>
							<div className="flex justify-between items-center">
								<span className="text-slate-300">月額基本料</span>
								<span className="font-semibold text-white">¥0</span>
							</div>
							<div className="flex justify-between items-center">
								<span className="text-slate-300">登録者数上限</span>
								<span className="font-semibold text-white">無制限</span>
							</div>
							<div className="flex justify-between items-center">
								<span className="text-slate-300">機能制限</span>
								<span className="font-semibold text-white">なし</span>
							</div>
						</div>
					</div>
			...
			<div className="max-w-6xl mx-auto">
				<div className="flex flex-col md:flex-row justify-between items-center gap-6">
					<div className="flex items-center gap-2.5">
						...
						<span className="font-bold text-xl text-white tracking-tight">WaitLine</span>
					</div>
