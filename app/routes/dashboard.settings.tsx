		...
		<>
			...
			<div className="space-y-6">
				<div className="bg-white rounded-xl border border-gray-200 p-6">
					...
					<div className="space-y-4">
						<label className="block">
							<span className="block text-sm font-medium text-gray-700 mb-1">サービス名</span>
							<input
								type="text"
						...
						<label className="block">
							<span className="block text-sm font-medium text-gray-700 mb-1">短い説明</span>
							<input
								type="text"
						...
						<label className="block">
							<span className="block text-sm font-medium text-gray-700 mb-1">詳細説明</span>
							<textarea
						...
						<label className="block">
							<span className="block text-sm font-medium text-gray-700 mb-1">カテゴリ</span>
						...
						<label className="block">
							<span className="block text-sm font-medium text-gray-700 mb-1">ローンチ予定日</span>
							<input
								type="date"
				...
				<div className="bg-white rounded-xl border border-gray-200 p-6">
					...
					<div className="space-y-4">
						<label className="block">
							<span className="block text-sm font-medium text-gray-700 mb-1">チャネルID</span>
							<input
								type="text"
						...
						<label className="block">
							<span className="block text-sm font-medium text-gray-700 mb-1">チャネルシークレット</span>
							<input
								type="password"
								placeholder="••••••••••••••••"
								className="w-full border border-gray-200 rounded-lg px-4 py-2"
						...
						<label className="block">
							<span className="block text-sm font-medium text-gray-700 mb-1">アクセストークン</span>
							<input
								type="password"
								placeholder="••••••••••••••••"
								className="w-full border border-gray-200 rounded-lg px-4 py-2"
